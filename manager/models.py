...
class User(AbstractBaseUser):
    ...
    phone_regexv = RegexValidator(regex=r'^\d{10,10}$', message="Phone number must be entered in the format: '999999999'. Only 10 digits allowed.")
    phone = models.CharField(validators=[phone_regexv], max_length=15)
...
class Provision(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('provisionItem', kwargs={'pk':self.id})